...
app.get('/:inst/:type/:p', function(req, res){
	...
	if (institution === 'all') {
		...
		sql2 = 'select ARTICLE.ID as ID, TITLE, CONTENT, PREPICURL, TIME, ACCESSNUM, HREF, TAGS, NAME from ARTICLE, INSTITUTION where INSTITUTION.ID = ARTICLE.INSTITUTIONID and TAGS like ? and INSTITUTIONID = ? order by date(TIME)'
